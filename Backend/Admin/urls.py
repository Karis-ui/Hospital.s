...
urlpatterns = [
    ...
    path('schedules/',API.AdminSchedule.as_view(),name='admin_schedules'),
    ...
    path('chart/view/',API.AdminChartDataAPIView.as_view(),name='admin_chart_data'),
    ...
    path('search/',API.AdminSearch.as_view(),name='search'),
    ...
    path('report/generate/',API.ReportGenerateView.as_view(),name='generate_report'),
    path('report/<int:report_id>/download/',API.DownloadReport.as_view(),name='download_report'),
    path('report/<int:report_id>/delete/',API.DeleteReport.as_view(),name='delete_report'),
]