  ...
  return (
    <Box sx={{ display: 'flex', bgcolor: platinumTheme.background.default, minHeight: '100vh' }}>
      <Sidebar>
        ...
        <Divider sx={{ borderColor: alpha(platinumTheme.text.light, 0.1) }} />
        ...
        <List sx={{ px: 2, py: 2 }}>
          ...
          <Typography variant="caption" sx={{ px: 2, mt: 2, color: alpha(platinumTheme.text.light, 0.5), fontWeight: 600 }}>
            MANAGEMENT
          </Typography>

          {[
            { icon: <PeopleIcon />, text: 'Patients', badge: patients?.length || '1,245', path: '/admin/patients' },
            { icon: <DoctorIcon />, text: 'Doctors', badge: doctors?.length || '86', path: '/admin/doctors' },
            { icon: <StaffIcon />, text: 'Staff', badge: staff?.length || '12', path: '/admin/staff' },
          ...
          {[
            { icon: <HospitalIcon />, text: 'Wards & Beds' },
            { icon: <PharmacyIcon />, text: 'Pharmacy' },
            { icon: <LabIcon />, text: 'Laboratory' },
            { icon: <EmergencyIcon />, text: 'Emergency' },
          ...
          {[
            { icon: <ApproveIcon />, text: 'Approvals', badge: pendingApprovals?.length || '8' },
            { icon: <ReportsIcon />, text: 'Reports & Analytics' },
            { icon: <SettingsIcon />, text: 'System Settings' },
