...
const steps = [
  ...
  },
  {
    ...
    description: 'Your medical credentials',
    icon: <HospitalIcon />,
  },
];
                ...
                <Grow in timeout={500}>
                  <Box>
                    ...
                    <GoldTextField
                      ...
                      margin="normal"
                      required
                      helperText="Your valid medical license number"
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <LicenseIcon />
                    ...
                    <GoldTextField
                      ...
                      margin="normal"
                      required
                      helperText="List your degrees and certifications (e.g., MD, MBBS, Board Certifications)"
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <QualificationIcon />
